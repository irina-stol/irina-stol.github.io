...
_Table 16. Summary of the most suitable GAM models for _**Lyme** _Bay. All variables are smoothed terms with knots set to 6 for GAM1 and 45 for the variable Time in GAM2 (to allow for capturing the historical time series)._
...
_Table 17. Summary of the most suitable GAM models for _**Lantivet**_Bay. All variables are smoothed terms with knots set to 6 for GAM1 and 45 for the variable Time in GAM2 (to allow for capturing the historical time series)._
